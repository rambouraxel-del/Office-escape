...
export const LEVEL_01: LevelDef = {
  ...
  decor: [
    { kind: 'zone', x: 250, y: 2075, w: 316, h: 124, color: 0xc7d8bd, text: 'TON BUREAU  •  DÉPART' },
    { kind: 'zone', x: 250, y: 92, w: 286, h: 108, color: COLORS.green, text: 'SORTIE  ↑' },
    { kind: 'zone', x: 92, y: 470, w: 116, h: 100, color: 0xe3bc90, text: '' },
    { kind: 'text', x: 92, y: 525, text: 'ALCÔVE', size: 11, color: 0x8b745c },
    { kind: 'text', x: 250, y: 1860, text: 'OBJECTIF  •  RENTRER CHEZ TOI', size: 13, color: 0x8c775c },
    { kind: 'text', x: 250, y: 1840, text: 'COULOIR PRINCIPAL', size: 13, color: 0x9b8b78 },
    { kind: 'text', x: 250, y: 1160, text: 'ZONE DU BOSS', size: 14, color: 0x806f83 },
    { kind: 'text', x: 250, y: 315, text: 'DERNIER OBSTACLE', size: 12, color: 0x9b6b55 },
    ...
    { kind: 'plant', x: 52, y: 1815, scale: 0.82 },
    { kind: 'plant', x: 445, y: 1370, scale: 0.75 },
    { kind: 'plant', x: 55, y: 1040, scale: 0.78 },
    { kind: 'plant', x: 444, y: 350, scale: 0.72 }
  ],
